...
namespace Dominio
{
    public class Sistema
    {
        ...
        private void PrecargaPartidos()
        {
            ...
            AltaPartido(new PartidoEliminatoria(BuscarSeleccionGanadora("Inglaterra"), false, false,"Final", 27, buscarSelecciones("Inglaterra", "Ecuador"), DateTime.Parse("2022-12-18 12:00:00"), "Finalizado", "Eliminatoria", null));
        ...
        {
            Registrar(new Usuario("JuanPerez@gmail.com", "JuanPerez1972", "Juan", "Perez"));
            Registrar(new Usuario("AlvezJuan@gmail.com", "Alvez4233", "Juan",  "Alvez"));
            Registrar(new Usuario("b123Blazi@gmail.com", "AlbertoBleeeeez1", "Alberto", "Blezi"));
            Registrar(new Usuario("lagunaHector@gmail.com", "Perro6643", "Hector", "Laguna"));
            Registrar(new Usuario("PirizD@gmail.com", "Diegote1566", "Diego", "Piriz"));
            Registrar(new Usuario("JuanSomm@gmail.com", "JuanJuanSom221", "Juan", "Som"));
            Registrar(new Usuario("JuanVillamil@gmail.com", "Villamil555", "Juan", "Villamil"));
            Registrar(new Usuario("LJuan@gmail.com", "JuanLLagun..2", "Juan", " Laguna"));
            Registrar(new Usuario("SCaceres@gmail.com", "SCACERES@@@", "Santiago", "Caceres"));
            Registrar(new Usuario("Viscardi42@gmail.com", "VisM22", "Milena", "Viscardi"));
        ...
        /*public void DefinirGanador()
        {
            ...
            {
                if (partido.Estado.Equals("Finalizado"))
                {
                    int contadorSeleccion1 = 0;
                    int contadorSeleccion2 = 0;
                    Seleccion seleccion1 = partido.selecciones[1];
                    Seleccion seleccion2 = partido.selecciones[2];
                    bool GanadorPorPenales = false;
                        ...
                        foreach (Incidencia i in incidencias)
                        {
                            if (i.Tipo.Equals("Gol"))
                            {
                                if (i.unPartido.Equals(partido))
                                {
                                    foreach (Seleccion s in partido.selecciones)
                                    {
                                        if (s.jugadores.Contains(i.unJugador))
                                        {
                    ...
                    RetornoResultado(contadorSeleccion1, contadorSeleccion2, seleccion1, seleccion2, GanadorPorPenales, partido);
                }
            }
        }
            ...
            string resultado = "";
                ...
                else
                {
                    ...
                    else
                    {
                        if (contadorSeleccion1 > contadorSeleccion2)
                        {
                            resultado = $"Empate en tiempo de juego. Ganador {seleccion1} en tanda de penales";
                        }
                        else
                        {
                            resultado = $"Empate en tiempo de juego. Ganador {seleccion2} en tanda de penales";
                        }
                    }
                }
        ...
        public List<Seleccion> VisualizarSelecciones()
        {
            selecciones.Sort(); 
            return selecciones;
            /*foreach(Seleccion s in auxListSeleccion)
            {
                Retorno+= $"Seleccion:{s} \n Jugadores: \n";
